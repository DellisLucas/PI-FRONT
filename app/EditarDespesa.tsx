...
export default function EditarDespesaScreen() {
  // Valores iniciais simulados para edição
  const [id, setId] = useState<string>('001');
  const [data, setData] = useState<string>('02-11-2024');
  const [descricao, setDescricao] = useState<string>('GASOLINA');
  const [valor, setValor] = useState<string>('80,00');
  ...
  return (
    <Container>
      <Card>
        ...
        <Input placeholder="ID" value={id} onChangeText={setId} editable={false} />
